...
def sort_and_randomize(file_path: str, randomize: bool=True) -> None:
    ...
    if randomize:
        output_file_path = 'band_name/data/er_sorted_randomized_candidate_names.txt'
    else:
        output_file_path = 'band_name/data/er_sorted_candidate_names.txt'
...
def main():
    file_path = "band_name/data/er_candidate_names.txt"
